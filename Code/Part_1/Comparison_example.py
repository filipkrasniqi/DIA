...
plt.xlabel("t")
plt.ylabel("Regret")
plt.plot(np.cumsum(np.mean(opt - ts_rewards_per_experiment,axis=0)),'r') # Red color for TS
plt.plot(np.cumsum(np.mean(opt - gr_rewards_per_experiment,axis=0)),'g') # Green color for GR
