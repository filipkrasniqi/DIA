...
bids = np.array([[5,2,1], [2,1,4], [3,4,1], [3,5,1], [3,4,1]])
slopes = -1* np.array([[0.5, 0.3, 0.1], [0.3, 0.1, 0.4], [0.4, 0.4, 0.1], [0.5, 0.5, 0.2], [0.3, 0.3, 0.1]])
max_clicks = np.array([[20,10,10], [15,10,25], [20,25,10], [20,25,10], [15,20,10]])
